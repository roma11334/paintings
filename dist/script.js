...
/* harmony import */ var _modules_object__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/object */ "./src/js/modules/object.js");
/* harmony import */ var _modules_drops__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/drops */ "./src/js/modules/drops.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_4__["default"])('#styles .row', '.button-styles');
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_9__["default"])('.burger', '.burger-menu');
  Object(_modules_object__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_modules_drops__WEBPACK_IMPORTED_MODULE_11__["default"])();
});
...
var accordion = function accordion(trigerSelector, itemSelector) {
  var btns = document.querySelectorAll(trigerSelector),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(btn, menuBurger) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promo, price) {
...
var drops = function drops() {
  ...
  ['dragenter', 'dragover', 'dragleave', 'drop'].forEach(function (drag) {
  ...
  function highligts(input) {
    input.closest('.file_upload').style.backgroundColor = 'black';
  }
  ...
  ['dragenter', 'dragover'].forEach(function (drag) {
    fileInputs.forEach(function (input) {
      input.addEventListener(drag, function () {
        return highligts(input);
      });
    });
  })[('dragleave', 'drop')].forEach(function (drag) {
    fileInputs.forEach(function (input) {
      input.addEventListener(drag, function () {
        return unhighligts(input);
      });
    });
  });
};
...
var filter = function filter() {
  ...
  var filterShow = function filterShow(elem) {
  ...
  loversBtn.addEventListener('click', function () {
  ...
  guyBtn.addEventListener('click', function () {
    filterShow(guyItems);
  });
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.classList.contains('calc_form')) {
        var calcPriceNew = document.querySelector('.calc-price');
      ...
      var res = Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(pathData, formData).then(function (res) {
        console.log(res);
        ...
        setTimeout(function () {
          ...
          item.classList.add('fadeInUp'); // hideContent('[data-modal]');
        }, 3000);
      });
    });
  });
...
/* harmony default export */ __webpack_exports__["default"] = (forms); // let risBut = document.createElement('button');
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var deleteBtn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var trigger = document.querySelectorAll(triggerSelector);
    var modal = document.querySelector(modalSelector);
    var close = document.querySelector(closeSelector);
    var close_data_modal = document.querySelectorAll('[data-modal]');
    var marginRight = computedMargin();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        close_data_modal.forEach(function (item) {
          item.style.display = 'none';
          item.classList.add('animated', 'fadeIn');
        });
  ...
  function computedMargin() {
    ...
    var marginR = x.offsetWidth - x.clientWidth;
    x.remove();
    return marginR;
  }
...
var picturesSize = function picturesSize(elem) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return regeneratorRuntime.awrap(promise.text());
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", status: ").concat(promise.status));

        case 5:
          _context2.next = 7;
          return regeneratorRuntime.awrap(promise.json());
